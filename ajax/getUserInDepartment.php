...
if (!isset($_POST['id_department'])) {echo json_encode(["status"=> false]);exit;}

$all_userInDep = R::getAll('SELECT * FROM `users` WHERE users.id_department = ?', array($_POST['id_department']));
echo json_encode($all_userInDep);
?>